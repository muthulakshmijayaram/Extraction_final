...
def summarize_pdf_by_page(file):
    try:
        ...
        message_parts = [
            "Extract the content from each page of the PDF. For each page, start with 'Page X' (where X is the page number), then the content. Separate each page with two newlines.",
            pdf_blob
        ]
